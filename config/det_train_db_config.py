...
config.train_options = {
    ...
    'ckpt_save_type': 'FixedEpochStep',  # HighestAcc：只保存最高准确率模型 ；FixedEpochStep：每隔ckpt_save_epoch个epoch保存一个
    ...
    'train': {
        'dataset': {
            ...
            'pre_processes': [{'type': 'IaaAugment', 'args': [{'type': 'Fliplr', 'args': {'p': 0.5}},
                              ...
                              {'type': 'EastRandomCropData', 'args': {'size': [224, 224], 'max_tries': 50, 'keep_ratio': True}},
